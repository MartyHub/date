...
public class TechnicalDate extends AbstractDate<TechnicalDate> {
    ...
    public static final TechnicalDate BEGIN_OF_TIME = new TechnicalDate(BusinessDate.BEGIN_OF_TIME, BusinessTime.BEGIN_OF_DAY);

    public static final TechnicalDate END_OF_TIME = new TechnicalDate(BusinessDate.END_OF_TIME, BusinessTime.END_OF_DAY);
